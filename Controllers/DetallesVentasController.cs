...
namespace UspgPOS.Controllers
{
    public class DetallesVentasController : Controller
    {
        ...
        {
            var detalleVenta = _context.DetallesVentas
                .Include(d => d.Venta)
        ...
        public async Task<IActionResult> Create([Bind("Id,VentaId,ProductoId,Cantidad,PrecioUnitario")] DetallesVenta detallesVenta)
        {
